document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateTotals(orders) {
        ...
        document.getElementById('outstandingBalance').textContent = `$${totals.balance.toFixed(2)}`;
        ...
        document.getElementById('tableOutstandingBalance').textContent = `$${totals.balance.toFixed(2)}`;
    }
